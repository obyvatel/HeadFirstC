...
int main()
{
	...
	al_destroy_sample(elephant);	// уничтожить звук elephant
	al_destroy_audio_stream(music);	// уничтожить потоковое аудио
